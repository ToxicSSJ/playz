...
@section('head')
<title>{{ __('audios.add_bundle_title') }} - PlayZ</title>
@endsection
        ...
        <div class="bs-stepper-header" role="tablist">
            <div class="step" data-target="#test-l-1">
              <button type="button" class="step-trigger" role="tab" id="stepper1trigger1" aria-controls="test-l-1">
                ...
                <span class="bs-stepper-label">{{ __('audios.bundle_information') }}</span>
              </button>
            </div>
            ...
            <div class="step" data-target="#test-l-3">
              <button type="button" class="step-trigger" role="tab" id="stepper1trigger3" aria-controls="test-l-3">
                ...
                <span class="bs-stepper-label">{{ __('audios.select') }}</span>
              </button>
            </div>
            <div class="bs-stepper-line"></div>
            ...
            <form action="{{ route('bundle.save') }}" method="post" enctype="multipart/form-data">
              ...
              <div id="test-l-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger1">
                <div class="form-group">
                  ...
                  <input name="title" type="title" class="form-control" id="title" value="{{ old('title') }}" placeholder="{{ __('audios.enter_bundle_title') }}">
                </div>
                <div class="form-group">
                  <label for="inputDescription">{{ __('audios.description') }}</label>
                  <input name="description" type="description" class="form-control" id="inputDescription" value="{{ old('description') }}" placeholder="{{ __('audios.enter_bundle_description') }}">
                </div>
                <div class="form-group">
              ...
              <div id="test-l-3" role="tabpanel" class="bs-stepper-pane text-center" aria-labelledby="stepper1trigger3">
                <div class="form-group">
                    <label for="inputType">{{ __('audios.select_audios') }}</label>
                    <select id="audios" class="selectpicker form-control" name="audios[]" multiple data-live-search="true" multiple title="{{ __('audios.choose_any') }}">
